...
OWNER_ID  =  daftar ( peta ( int , getenv ( 'OWNER_ID' , '5252066045' ). split ()))
GROUP  =  getenv ( "GROUP" , Tidak Ada )
CHANNEL = getenv("CHANNEL", None)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
UPSTREAM_REPO    =    getenv ( "UPSTREAM_REPO" , "https://github.com/Skoyibot/musicozos" )
